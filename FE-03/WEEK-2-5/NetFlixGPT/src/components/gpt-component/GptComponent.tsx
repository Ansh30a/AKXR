...
import { fetchTitles } from "../../lib/ai";
...
const GptComponent: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen text-white pt-24 md:pt-32 px-4 md:px-10">
            ...
            <h1 className="text-2xl md:text-4xl font-bold mb-8 md:mb-12 text-center md:text-left">
                Results for{" "}
